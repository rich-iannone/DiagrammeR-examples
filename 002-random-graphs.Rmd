...
So, using `n = 15` and `m = 105` will yield a fully-connected graph with 15 nodes (this is the same as using `create_graph() %>% add_full_graph(n = 15, keep_loops = FALSE)`). Here is the output graph:
