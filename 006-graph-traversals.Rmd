...
Now that we have a property graph, we can find out bits of information without directly inspecting such information (i.e., not working with the graph's internal node or edge data frames). This will be important when a property graph becomes larger or more complex since manual work with these data frames gets difficult and impractical.
