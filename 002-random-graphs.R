...
render_graph(create_random_graph(n = 2, m = 1),
             output = "visNetwork")

# It's better with more nodes and edges. Try 15
# nodes, and 30 edges:

render_graph(create_random_graph(n = 15, m = 30),
             output = "visNetwork")
...
render_graph(create_random_graph(n = 15, m = 200),
             output = "visNetwork")
...
render_graph(create_random_graph(n = 5, m = 4,
                                 set_seed = 30),
             output = "visNetwork")
...
render_graph(create_random_graph(n = 15, m = 22,
                                 directed = TRUE),
             output = "visNetwork")
